        ...
        <ScrollView>
          <View style={styles.container}>
            ...
            <View style={styles.listcontainer}>
              <Text style={styles.listTitle}>Damage taken from</Text>
              ...
              {this.state.dataAPI.damage_relations.half_damage_from.length >
              0 ? (
                <View style={styles.listBox}>
                  {this.damage_relations(
            ...
            <View style={styles.listcontainer}>
              <Text style={styles.listTitle}>Damage given to</Text>
              {this.state.dataAPI.damage_relations.double_damage_to.length >
              0 ? (
                <View style={styles.listBox}>
                  {this.damage_relations(
